/* ngat_dprt_o_DpRtLibrary.c
** Implementation of Java Classes ngat.dprt.o.DpRtLibrary.java native Interfaces
** $Header: /home/cjm/cvs/libdprt-o/c/ngat_dprt_o_DpRtLibrary.c,v 1.1 2011-11-23 11:09:34 cjm Exp $
*/
/**
 * ngat_dprt_o_DpRtLibrary.c is the  `glue' between libdprt_o and ngat.dprt.o.DpRtLibrary.java.
...
#include <string.h>
#include <jni.h>
#include "ngat_dprt_o_DpRtLibrary.h"
#include "object.h"
#include "dprt.h"
 ...
 */
static char rcsid[] = "$Id: ngat_dprt_o_DpRtLibrary.c,v 1.1 2011-11-23 11:09:34 cjm Exp $";
...
/**
 * Class:     ngat_dprt_o_DpRtLibrary<br>
 * Method:    DpRt_Initialise<br>
 * Signature: ()V<br>
 * @param env The JNI environment pointer.
 * @param obj The instance of ngat.dprt.o.DpRtLibrary this method was called with.
 ...
 */
JNIEXPORT void JNICALL Java_ngat_dprt_o_DpRtLibrary_DpRt_1Initialise(JNIEnv *env,jobject obj)
{
	int retval;
 ...
 * @see ../../jni_general/cdocs/dprt_jni_general.html#DpRt_JNI_Throw_Exception
 */
JNIEXPORT void JNICALL Java_ngat_dprt_o_DpRtLibrary_DpRt_1Shutdown(JNIEnv *env,jobject obj)
{
	int retval;
 ...
 * Java Native Interface implementation ngat.dprt.o.DpRtLibrary's setStatus.
 ...
 */
JNIEXPORT void JNICALL Java_ngat_dprt_o_DpRtLibrary_DpRt_1Set_1Status(JNIEnv *env,jobject obj,jobject status)
{
 ...
 * Java Native Interface implementation ngat.dprt.o.DpRtLibrary's initialiseLoggerReference.
 ...
 * @param l The DpRtLibrary's "ngat.dprt.o.DpRtLibrary" logger.
 * @see ../../jni_general/cdocs/dprt_jni_general.html#DpRt_JNI_Initialise_Logger_Reference
 */
JNIEXPORT void JNICALL Java_ngat_dprt_o_DpRtLibrary_initialiseLoggerReference(JNIEnv *env, jobject obj, jobject l)
{
 ...
 * Signature: ()V<br>
 * This native method is called from ngat.dprt.o.DpRtLibrary's finaliser method. It removes the global reference to
 * logger.
 * @see ../../jni_general/cdocs/dprt_jni_general.html#DpRt_JNI_Finalise_Logger_Reference
 */
JNIEXPORT void JNICALL Java_ngat_dprt_o_DpRtLibrary_finaliseLoggerReference(JNIEnv *env, jobject obj)
{
 ...
 * JNI interface routine called when ngat.dprt.o.DpRtLibrary.DpRtCalibrateReduce is called.
 * @param env The JNI environment pointer.
 * @param object The instance of ngat.dprt.o.DpRtLibrary this method was called with.
 ...
 */
JNIEXPORT jboolean JNICALL Java_ngat_dprt_o_DpRtLibrary_DpRt_1Calibrate_1Reduce(JNIEnv *env,jobject object,
 ...
 * JNI interface routine called when ngat.dprt.o.DpRtLibrary.DpRtExposeReduce is called.
 * @param env The JNI environment pointer.
 ...
 */
JNIEXPORT jboolean JNICALL Java_ngat_dprt_o_DpRtLibrary_DpRt_1Expose_1Reduce(JNIEnv *env,jobject obj,
				     jstring input_filename_string,jobject reduce_done)
{
	char error_string[DPRT_ERROR_STRING_LENGTH];
	const char *input_filename = NULL;
 ...
 * @see ../../jni_general/cdocs/dprt_jni_general.html#DpRt_JNI_Set_Reduce_Done
 */
JNIEXPORT jboolean JNICALL Java_ngat_dprt_o_DpRtLibrary_DpRt_1Make_1Master_1Bias(JNIEnv *env,jobject obj,
 ...
 * @see ../../jni_general/cdocs/dprt_jni_general.html#DpRt_JNI_Set_Reduce_Done
 */
JNIEXPORT jboolean JNICALL Java_ngat_dprt_o_DpRtLibrary_DpRt_1Make_1Master_1Flat(JNIEnv *env,jobject obj,
 ...
 * Signature: ()V<br>
 * JNI interface routine called when ngat.dprt.o.DpRtLibrary.DpRtAbort is called.
 * @param env The JNI environment pointer.
 * @param object The instance of ngat.dprt.o.DpRtLibrary this method was called with.
 * @see ../../jni_general/cdocs/dprt_jni_general.html#DpRt_JNI_Set_Abort
 */
JNIEXPORT void JNICALL Java_ngat_dprt_o_DpRtLibrary_DpRt_1Abort(JNIEnv *env, jobject obj)
{
 ...
 */
JNIEXPORT void JNICALL Java_ngat_dprt_o_DpRtLibrary_DpRt_1Finalise_1References(JNIEnv *env, jobject obj)
{
