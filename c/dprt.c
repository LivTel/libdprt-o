...
** $Header: /home/cjm/cvs/libdprt-o/c/dprt.c,v 1.1 2011-10-31 13:51:17 cjm Exp $
*/
/**
 ...
 */
static char rcsid[] = "$Id: dprt.c,v 1.1 2011-10-31 13:51:17 cjm Exp $";
...
/* are we doing a fake reduction or a real one. */
	...
	else
	{
		if(make_master_bias)
		{
			fprintf(stdout,"DpRt_Make_Master_Bias:NOT Calling Make Master Bias routine (dprt_process).\n");
